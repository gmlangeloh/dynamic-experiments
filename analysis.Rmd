...
explore_gf <- function(instance_name) {
  ...
  g <- ggplot() +
    ...
    geom_point(data=data, aes(x=polynomials, y=degree, color=algorithm), size=3, position=position_dodge(width=0.3)) +
    ggtitle(instance_name) #+ 
    #theme(legend.position=c(0.8, 1.0))
