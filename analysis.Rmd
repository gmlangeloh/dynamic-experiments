...
cp %>% group_by(reducer) %>% summarize(mean=mean(time, na.rm=TRUE))
static %>% group_by(reducer) %>% summarize(mean=mean(time, na.rm=TRUE))
perturb %>% group_by(reducer) %>% summarize(mean=mean(time, na.rm=TRUE))
